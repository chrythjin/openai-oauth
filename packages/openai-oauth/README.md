...
| Codex API version | `--codex-version`   | Local `codex --version`, then `@openai/codex` latest from npm, then `0.124.0`                                                                          | Override the Codex API client version used for model discovery.                                                                    |
